...
export const LEVELS = [
  ...
  },
  {
    ...
    name: "Wave Lane",
    tagline: "Eight scripted waves in a lane. Read, sweep, don't get pinched.",
    chapter: 1,
    order: 3,
    mode: MODE.WAVES,
    ...
    rules: {
      ...
      waves: [
        ...
        },
        {
          ...
          count: 2,
          pattern: SPAWN_PATTERN.EDGE_LINE,
          patternOpts: { side: 1, stagger: 0.18 },
        },
        {
          id: "w7",
          label: "RIFT",
          ...
          patternOpts: { corner: 1, stagger: 0.12 },
        },
        {
          id: "w8",
          label: "FLOOD",
          types: ["wanderer", "diamond", "pink"],
          count: 12,
          pattern: SPAWN_PATTERN.CORNER_FLOOD,
          patternOpts: { stagger: 0.05 },
        },
      ],
    },
    stars: {
  ...
  },
  {
    ...
    name: "Cross Gates",
    tagline: "Hit every gate. Survive the clock. Gates clear a pocket — no points.",
    chapter: 1,
    order: 4,
    ...
    skillLesson: "Route the plus, detonate gates, farm the rest of the clock.",
  },
  {
  ...
  },
  {
    ...
    name: "Split Signal",
    tagline: "Eight chamber waves. One seal beat. Don't get trapped.",
    chapter: 2,
    order: 6,
    mode: MODE.WAVES,
    ...
    rules: {
      ...
      waves: [
        ...
        },
        {
          ...
          count: 2,
          pattern: SPAWN_PATTERN.EDGE_LINE,
          patternOpts: { side: 2, stagger: 0.2 },
        },
        {
          id: "s7",
          label: "SLAB",
          ...
          count: 2,
          pattern: SPAWN_PATTERN.PINCER,
          patternOpts: { axis: "vertical", stagger: 0.15 },
          seal: true,
        },
        {
          id: "s8",
  ...
  },
  {
    ...
    skillLesson: "Edges are doors. Wrap shots. Don't die for scraps.",
  },
  {
    id: "path-08-boss-pulse",
    name: "Boss Pulse",
    tagline: "Three-phase elite. Bombs chip. The floor pinches.",
    chapter: 2,
    order: 8,
    mode: MODE.BOSS_LITE,
    ...
    skillLesson: "Chip with bombs, dodge the pinch, don't dump lives for a fast 3★.",
  },
];
...
export function normalizeProgress(progress) {
  ...
  return {
    ...
    version: p.version === 3 ? 3 : p.version === 2 ? 2 : 1,
  };
}
